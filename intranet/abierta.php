...
<?php
    ...
    $sqlServicio = "SELECT fecha, cliente, emailuser, servicio, valor, realizado FROM servicios WHERE fecha >= DATE_SUB(CURDATE(), INTERVAL 14 DAY) ORDER BY fecha DESC";
    $sqlInsumo = "SELECT fecha, producto, coste, cantidad, marca FROM insumos WHERE fecha >= DATE_SUB(CURDATE(), INTERVAL 14 DAY) ORDER BY fecha DESC";
    $sumaServicio = "SELECT fecha, SUM(valor) AS 'totalValor' FROM servicios WHERE fecha >= DATE_SUB(CURDATE(), INTERVAL 14 DAY) ORDER BY fecha DESC";
    $sumaInsumo = "SELECT fecha, SUM(coste) AS 'totalCoste' FROM insumos WHERE fecha >= DATE_SUB(CURDATE(), INTERVAL 14 DAY) ORDER BY fecha DESC";
